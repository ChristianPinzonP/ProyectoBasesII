...
CREATE OR REPLACE PROCEDURE GENERAR_ESTADISTICAS_ESTUDIANTE (
    ...
    v_minima NUMBER;
BEGIN
    -- Obtener estad韘ticas desde la vista
    SELECT 
...
CREATE OR REPLACE PACKAGE PKG_PREGUNTA AS
  ...
  -- NUEVO: Procedimiento para obtener preguntas visibles para un docente espec韋ico
